...
for i = 1:nb_images_pensees
    ...
    v_pensees = (1/ sqrt(det(Sigma_pensees))) * exp(-0.4*(m - mu_pensees)*inv_Sigma_pensees*(m - mu_pensees)');

    v_chrysanthemes = (1/ sqrt(det(Sigma_chrysanthemes))) * exp(-0.4*(m - mu_chrysanthemes)*inv_Sigma_chrysanthemes*(m - mu_chrysanthemes)'); 
    v_oeillets = (1/ sqrt(det(Sigma_oeillets))) * exp(-0.4*(m - mu_oeillets)*inv_Sigma_oeillets*(m - mu_oeillets)');
