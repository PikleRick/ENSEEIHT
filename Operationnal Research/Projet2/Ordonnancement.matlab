...
%
% Application au problème d ordonnancement sous forme d'un graphe (X,U)
%  modélisé comme un problème de tension maximale
% voir Exemple_ordonnancement.pdf sur moodle
%
